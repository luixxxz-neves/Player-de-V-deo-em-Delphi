...
// $Rev: 8291 $
// File generated on 24/07/2026 14:05:53 from Type Library described below.
...
// *********************************************************************//
  _WMPOCXEvents = dispinterface
    ...
    procedure DeviceEstimation(const pDevice: IWMPSyncDevice; hrResult: HResult; 
                               qwEstimatedUsedSpace: {??Int64}OleVariant; 
                               qwEstimatedSpace: {??Int64}OleVariant); dispid 6527;
...
// *********************************************************************//
  IWMPDMRRenderingControlServiceDisp = dispinterface
    ...
    property volume: {??Word}OleVariant readonly dispid 4;
    ...
    procedure GetVolume(ulInstanceID: LongWord; const bstrChannel: WideString; 
                        var puiCurrentVolume: {??Word}OleVariant); dispid 12;
    procedure SetVolume(ulInstanceID: LongWord; const bstrChannel: WideString; 
                        uiDesiredVolume: {??Word}OleVariant); dispid 13;
  end;
...
// *********************************************************************//
  ...
  TWindowsMediaPlayerDeviceEstimation = procedure(ASender: TObject; const pDevice: IWMPSyncDevice; 
                                                                    hrResult: HResult; 
                                                                    qwEstimatedUsedSpace: {??Int64}OleVariant; 
                                                                    qwEstimatedSpace: {??Int64}OleVariant) of object;
